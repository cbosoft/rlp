...
void VertexInteractionTest::run(Vec3 point, bool expected_result)
{
  ...
  int number_arrangements = box.get_number_arrangements();
  if (number_arrangements != 1)
    this->fail(Formatter() << "Incorrect number of arrangments! Expected 1, got " << number_arrangements << "." );
